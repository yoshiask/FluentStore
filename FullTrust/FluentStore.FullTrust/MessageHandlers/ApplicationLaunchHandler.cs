...
namespace FluentStore.FullTrust.MessageHandlers
{
    public class ApplicationLaunchHandler : IMessageHandler
    {
        ...
        private async void HandleApplicationLaunch(string application, Dictionary<string, object> message)
        {
            ...
            if (message.TryGetValue("Parameters", out var argumentsObj))
                arguments = (string)argumentsObj;
            else
                arguments = string.Empty;

            string workingDirectory = null;
            if (message.TryGetValue("WorkingDirectory", out var workingDirectoryObj))
                workingDirectory = (string)workingDirectoryObj;
            else
