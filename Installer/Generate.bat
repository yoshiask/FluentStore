...
MOVE "%~dp0MSIX Signer\Packages\%MSIXSIGNERBEFORE%ARM%MSIXSIGNERAFTER%\%MSIXSIGNERBEFORE%ARM.msix" "%~dp0Windows 10 Mobile\Package ARM.msix"
...
MOVE "MSIX Signer\Packages\%MSIXSIGNERBEFORE%x64%MSIXSIGNERAFTER%\%MSIXSIGNERBEFORE%x64.msix" "MSIX Signer\Packages\Package x64.msix"
...
MOVE "MSIX Signer\Packages\%MSIXSIGNERBEFORE%x86%MSIXSIGNERAFTER%\%MSIXSIGNERBEFORE%x86.msix" "MSIX Signer\Packages\Package x86.msix"
...
MOVE "MSIX Signer\Packages\%MSIXSIGNERBEFORE%ARM64%MSIXSIGNERAFTER%\%MSIXSIGNERBEFORE%ARM64.msix" "MSIX Signer\Packages\Package ARM64.msix"
