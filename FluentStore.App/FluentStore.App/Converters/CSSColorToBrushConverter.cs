...
namespace FluentStore.Converters
{
    public class CSSColorToBrushConverter : IValueConverter
    {
        ...
        public static System.Drawing.Color ParseCSSColorAsDrawingColor(string cssString)
        {
            ...
            else if (cssString[0] == '#')
            {
                switch (cssString.Length)
                {
                    case 9:
                        {
                            var cuint = System.Convert.ToUInt32(cssString[1..], 16);
                            var a = (byte)(cuint >> 24);
                    ...
                    case 5:
                        {
                            var cuint = System.Convert.ToUInt16(cssString[1..], 16);
                            var a = (byte)(cuint >> 12);
        ...
        public static Dictionary<string, string> NamedCSSColors = new()
        {
            { "AliceBlue", "#F0F8FF" },
            { "AntiqueWhite", "#FAEBD7" },
            { "Aqua", "#00FFFF" },
